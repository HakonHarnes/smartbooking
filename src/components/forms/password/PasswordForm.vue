...
export default {
    ...
    computed: {
        ...
        confirmPasswordStyle() {
            if (this.confirmPassword.length === 0) return 'border-bottom: 5px solid #8f8f8f';
            if (!this.equalPassword) return 'border-bottom: 5px solid #f95e68';
            return 'border-bottom: 5px solid #89bb1d;';
        }
    },
    data() {
        return {
